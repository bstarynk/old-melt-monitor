...
#error MOM_PREDEFINED_NAMED should be defined
#endif

#ifndef MOM_PREDEFINED_ANONYMOUS
#error MOM_PREDEFINED_ANONYMOUS should be defined
#endif
...
/// anonymous predefined: MOM_PREDEFINED_ANONYOUS(Id)
/// just one useless anonymous, for testing
MOM_PREDEFINED_ANONYMOUS(_1dc054h62cc_1w91q0750st)
