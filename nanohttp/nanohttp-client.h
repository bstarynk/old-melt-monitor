 ...
 *
 */
  int httpc_add_header (httpc_conn_t * conn, const char *key,
			const char *value);
 ...
 *
 */
  int httpc_set_basic_authorization (httpc_conn_t * conn, const char *user,
				     const char *password);
...
*/
  herror_t httpc_get (httpc_conn_t * conn, hresponse_t ** out,
		      const char *urlstr);
